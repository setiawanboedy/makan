            ...
            <div class="row g-0 gx-5 align-items-end">
                <div class="col-lg-6">
                    <div class="text-start mx-auto mb-5 wow slideInLeft" data-wow-delay="0.1s">
                        <h1 class="mb-3">Terdekat dengan Anda</h1>
                            ...
                            <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                                <div class="property-item rounded overflow-hidden">
                                    <div class="img-item position-relative overflow-hidden">
                                        <a href="{{ route('kuliner-detail', $item->id) }}"><img class=" img-fluid"
                                    ...
                                    <div class="d-flex border-top">
                                        <small class="flex-fill text-center border-end py-2"><i
                                            ...
                                            Km</small>
                                        <small class="flex-fill text-center border-end py-2"><i
                                                class="fa fa-table text-primary me-2"></i>{{ $item->table }} Meja</small>
                                        <small class="flex-fill text-center border-end py-2"><i
                                                class="fa fa-home text-primary me-2"></i>{{ $item->room }} Ruangan</small>
                                    </div>
                                </div>
                            </div>
                        @empty
